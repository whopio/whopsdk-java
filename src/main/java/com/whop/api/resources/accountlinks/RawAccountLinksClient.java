...
public class RawAccountLinksClient {
    protected final ClientOptions clientOptions;

    public RawAccountLinksClient(ClientOptions clientOptions) {
     ...
     */
    public WhopApiHttpResponse<AccountLink> create(CreateAccountLinksRequest request) {
     ...
     * Generate a URL that directs a sub-merchant to their account portal, such as the hosted payouts dashboard or the KYC onboarding flow.
     */
    public WhopApiHttpResponse<AccountLink> create(CreateAccountLinksRequest request, RequestOptions requestOptions) {
