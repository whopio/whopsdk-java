...
public final class CreatePayoutsResponsePayoutMethodSupportedPayoutMethodDeliveryType {
    ...
    public static final CreatePayoutsResponsePayoutMethodSupportedPayoutMethodDeliveryType HOME_DELIVERY =
            new CreatePayoutsResponsePayoutMethodSupportedPayoutMethodDeliveryType(
    ...
    public static final CreatePayoutsResponsePayoutMethodSupportedPayoutMethodDeliveryType CASH_PICKUP =
            new CreatePayoutsResponsePayoutMethodSupportedPayoutMethodDeliveryType(Value.CASH_PICKUP, "cash_pickup");

    public static final CreatePayoutsResponsePayoutMethodSupportedPayoutMethodDeliveryType BILL =
            new CreatePayoutsResponsePayoutMethodSupportedPayoutMethodDeliveryType(Value.BILL, "bill");

    private final Value value;

    private final String string;

    CreatePayoutsResponsePayoutMethodSupportedPayoutMethodDeliveryType(Value value, String string) {
        this.value = value;
        this.string = string;
    }
    ...
    public boolean equals(Object other) {
        return (this == other)
                || (other instanceof CreatePayoutsResponsePayoutMethodSupportedPayoutMethodDeliveryType
                        && this.string.equals(
                                ((CreatePayoutsResponsePayoutMethodSupportedPayoutMethodDeliveryType) other).string));
    }
    ...
    public static CreatePayoutsResponsePayoutMethodSupportedPayoutMethodDeliveryType valueOf(String value) {
        switch (value) {
            ...
            case "bill":
                return BILL;
            default:
                return new CreatePayoutsResponsePayoutMethodSupportedPayoutMethodDeliveryType(Value._UNKNOWN, value);
        }
    }
