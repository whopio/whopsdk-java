...
public final class ListSupportedMethodsResponseDataItemDeliveryType {
    ...
    public static final ListSupportedMethodsResponseDataItemDeliveryType CASH_PICKUP =
            new ListSupportedMethodsResponseDataItemDeliveryType(Value.CASH_PICKUP, "cash_pickup");

    public static final ListSupportedMethodsResponseDataItemDeliveryType BILL =
            new ListSupportedMethodsResponseDataItemDeliveryType(Value.BILL, "bill");

    private final Value value;

    private final String string;

    ListSupportedMethodsResponseDataItemDeliveryType(Value value, String string) {
        this.value = value;
        this.string = string;
    }
    ...
    public boolean equals(Object other) {
        return (this == other)
                || (other instanceof ListSupportedMethodsResponseDataItemDeliveryType
                        && this.string.equals(((ListSupportedMethodsResponseDataItemDeliveryType) other).string));
    }
