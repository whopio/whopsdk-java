...
@JsonDeserialize(builder = ListLeadsRequest.Builder.class)
public final class ListLeadsRequest {
    ...
    /**
     * @return Filter leads to only those associated with these specific product identifiers.
     */
    ...
    /**
     * @return The unique identifier of the company to list leads for.
     */
    ...
    /**
     * @return Only return leads created after this timestamp.
     */
    ...
    /**
     * @return Only return leads created before this timestamp.
     */
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ListLeadsRequest && equalTo((ListLeadsRequest) other);
    }
    ...
    private boolean equalTo(ListLeadsRequest other) {
    ...
    public interface CompanyIdStage {
        /**
         * <p>The unique identifier of the company to list leads for.</p>
         */
        _FinalStage companyId(@NotNull String companyId);

        Builder from(ListLeadsRequest other);
    }

    public interface _FinalStage {
        ListLeadsRequest build();
        ...
        /**
         * <p>Filter leads to only those associated with these specific product identifiers.</p>
         */
        ...
        /**
         * <p>Only return leads created after this timestamp.</p>
         */
        ...
        /**
         * <p>Only return leads created before this timestamp.</p>
         */
    ...
    public static final class Builder implements CompanyIdStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ListLeadsRequest other) {
        ...
        @java.lang.Override
        public ListLeadsRequest build() {
            return new ListLeadsRequest(
                    productIds,
                    after,
                    before,
                    first,
