 ...
 */
package com.whop.api.resources.coursestudents.requests;
...
@JsonDeserialize(builder = ListCourseStudentsRequest.Builder.class)
public final class ListCourseStudentsRequest {
    ...
    private ListCourseStudentsRequest(
    ...
    /**
     * @return The unique identifier of the course to list enrolled students for.
     */
    ...
    /**
     * @return A search term to filter students by name or username.
     */
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ListCourseStudentsRequest && equalTo((ListCourseStudentsRequest) other);
    }
    ...
    private boolean equalTo(ListCourseStudentsRequest other) {
    ...
    @java.lang.Override
    public int hashCode() {
        return Objects.hash(this.after, this.before, this.first, this.last, this.courseId, this.keyword);
    }
    ...
    public interface CourseIdStage {
        /**
         * <p>The unique identifier of the course to list enrolled students for.</p>
         */
        _FinalStage courseId(@NotNull String courseId);

        Builder from(ListCourseStudentsRequest other);
    }

    public interface _FinalStage {
        ListCourseStudentsRequest build();
        ...
        /**
         * <p>A search term to filter students by name or username.</p>
         */
    ...
    public static final class Builder implements CourseIdStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ListCourseStudentsRequest other) {
        ...
        @java.lang.Override
        public ListCourseStudentsRequest build() {
            return new ListCourseStudentsRequest(after, before, first, last, courseId, keyword, additionalProperties);
        }
