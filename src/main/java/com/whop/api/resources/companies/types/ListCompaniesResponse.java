...
public final class ListCompaniesResponse {
    private final List<CompanyListItem> data;
    ...
    private ListCompaniesResponse(
            List<CompanyListItem> data, PageInfo pageInfo, Map<String, Object> additionalProperties) {
        this.data = data;
     ...
     */
    @JsonProperty("data")
    public List<CompanyListItem> getData() {
        return data;
    }
    ...
    public interface _FinalStage {
         ...
         * <p>A list of nodes.</p>
         */
        _FinalStage data(List<CompanyListItem> data);

        _FinalStage addData(CompanyListItem data);

        _FinalStage addAllData(List<CompanyListItem> data);
    }
    ...
    public static final class Builder implements PageInfoStage, _FinalStage {
        ...
        private List<CompanyListItem> data = new ArrayList<>();
         ...
         */
        @java.lang.Override
        public _FinalStage addAllData(List<CompanyListItem> data) {
            if (data != null) {
         ...
         */
        @java.lang.Override
        public _FinalStage addData(CompanyListItem data) {
            this.data.add(data);
            return this;
        }
        ...
        public _FinalStage data(List<CompanyListItem> data) {
            this.data.clear();
            if (data != null) {
                this.data.addAll(data);
            }
        ...
        public ListCompaniesResponse build() {
            return new ListCompaniesResponse(data, pageInfo, additionalProperties);
        }
