...
@JsonDeserialize(builder = ListChatChannelsRequest.Builder.class)
public final class ListChatChannelsRequest {
    ...
    private ListChatChannelsRequest(
    ...
    /**
     * @return The unique identifier of the company to list chat channels for.
     */
    ...
    /**
     * @return The unique identifier of a product to filter by. When set, only chat channels connected to this product are returned.
     */
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ListChatChannelsRequest && equalTo((ListChatChannelsRequest) other);
    }
    ...
    private boolean equalTo(ListChatChannelsRequest other) {
    ...
    @java.lang.Override
    public int hashCode() {
        return Objects.hash(this.after, this.before, this.first, this.last, this.companyId, this.productId);
    }
    ...
    public interface CompanyIdStage {
        /**
         * <p>The unique identifier of the company to list chat channels for.</p>
         */
        _FinalStage companyId(@NotNull String companyId);

        Builder from(ListChatChannelsRequest other);
    }

    public interface _FinalStage {
        ListChatChannelsRequest build();
        ...
        /**
         * <p>The unique identifier of a product to filter by. When set, only chat channels connected to this product are returned.</p>
         */
    ...
    public static final class Builder implements CompanyIdStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ListChatChannelsRequest other) {
        ...
        @java.lang.Override
        public ListChatChannelsRequest build() {
            return new ListChatChannelsRequest(after, before, first, last, companyId, productId, additionalProperties);
        }
