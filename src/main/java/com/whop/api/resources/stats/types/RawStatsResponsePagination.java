...
@JsonDeserialize(builder = RawStatsResponsePagination.Builder.class)
public final class RawStatsResponsePagination {
    private final Optional<String> nextCursor;

    private final Map<String, Object> additionalProperties;

    private RawStatsResponsePagination(Optional<String> nextCursor, Map<String, Object> additionalProperties) {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof RawStatsResponsePagination && equalTo((RawStatsResponsePagination) other);
    }
    ...
    private boolean equalTo(RawStatsResponsePagination other) {
    ...
    public static final class Builder {
        ...
        public Builder from(RawStatsResponsePagination other) {
        ...
        public RawStatsResponsePagination build() {
            return new RawStatsResponsePagination(nextCursor, additionalProperties);
        }
