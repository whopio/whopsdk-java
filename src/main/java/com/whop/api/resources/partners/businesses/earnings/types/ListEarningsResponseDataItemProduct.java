...
@JsonDeserialize(builder = ListEarningsResponseDataItemProduct.Builder.class)
public final class ListEarningsResponseDataItemProduct {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ListEarningsResponseDataItemProduct
                && equalTo((ListEarningsResponseDataItemProduct) other);
    }
    ...
    private boolean equalTo(ListEarningsResponseDataItemProduct other) {
    ...
    public interface IdStage {
        ...
        Builder from(ListEarningsResponseDataItemProduct other);
    }
    ...
    public interface _FinalStage {
        ListEarningsResponseDataItemProduct build();
    ...
    public static final class Builder implements IdStage, RouteStage, TitleStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ListEarningsResponseDataItemProduct other) {
            id(other.getId());
        ...
        @java.lang.Override
        public ListEarningsResponseDataItemProduct build() {
            return new ListEarningsResponseDataItemProduct(id, route, title, additionalProperties);
        }
