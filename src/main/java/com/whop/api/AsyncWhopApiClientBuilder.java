...
import com.whop.api.core.LogConfig;
import java.util.HashMap;
import java.util.Map;
import java.util.Optional;
import okhttp3.OkHttpClient;

public class AsyncWhopApiClientBuilder {
    ...
    private String apiVersionDate = null;
     ...
     * Sets token
     */
    public AsyncWhopApiClientBuilder token(String token) {
        this.token = token;
        return this;
    }
     ...
     * Sets apiVersionDate
     */
    public AsyncWhopApiClientBuilder apiVersionDate(String apiVersionDate) {
     ...
     * Sets idempotencyKey
     */
    public AsyncWhopApiClientBuilder idempotencyKey(String idempotencyKey) {
        this.idempotencyKey = idempotencyKey;
        return this;
    }

    public AsyncWhopApiClientBuilder environment(Environment environment) {
        this.environment = environment;
        return this;
    }

    public AsyncWhopApiClientBuilder url(String url) {
     ...
     */
    public AsyncWhopApiClientBuilder timeout(int timeout) {
     ...
     */
    public AsyncWhopApiClientBuilder maxRetries(int maxRetries) {
     ...
     */
    public AsyncWhopApiClientBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public AsyncWhopApiClientBuilder logging(LogConfig logging) {
     ...
     */
    public AsyncWhopApiClientBuilder addHeader(String name, String value) {
     ...
     */
    protected void setCustomHeaders(ClientOptions.Builder builder) {
        if (this.apiVersionDate != null) {
            builder.addHeader("Api-Version-Date", this.apiVersionDate);
        }
        if (this.idempotencyKey != null) {
            builder.addHeader("Idempotency-Key", this.idempotencyKey);
        }
    }
    ...
    public AsyncWhopApiClient build() {
        validateConfiguration();
        return new AsyncWhopApiClient(buildClientOptions());
    }
}
