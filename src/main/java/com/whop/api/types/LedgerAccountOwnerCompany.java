...
@JsonDeserialize(builder = LedgerAccountOwnerCompany.Builder.class)
public final class LedgerAccountOwnerCompany {
    ...
    private LedgerAccountOwnerCompany(String id, String route, String title, Map<String, Object> additionalProperties) {
        this.id = id;
        this.route = route;
        this.title = title;
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof LedgerAccountOwnerCompany && equalTo((LedgerAccountOwnerCompany) other);
    }
    ...
    private boolean equalTo(LedgerAccountOwnerCompany other) {
    ...
    public interface IdStage {
        ...
        Builder from(LedgerAccountOwnerCompany other);
    }
    ...
    public interface _FinalStage {
        LedgerAccountOwnerCompany build();
    ...
    public static final class Builder implements IdStage, RouteStage, TitleStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(LedgerAccountOwnerCompany other) {
            id(other.getId());
        ...
        @java.lang.Override
        public LedgerAccountOwnerCompany build() {
            return new LedgerAccountOwnerCompany(id, route, title, additionalProperties);
        }
