...
@JsonDeserialize(builder = ExperienceCompany.Builder.class)
public final class ExperienceCompany {
    ...
    private ExperienceCompany(String id, String route, String title, Map<String, Object> additionalProperties) {
        this.id = id;
        this.route = route;
        this.title = title;
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ExperienceCompany && equalTo((ExperienceCompany) other);
    }
    ...
    private boolean equalTo(ExperienceCompany other) {
    ...
    public interface IdStage {
        ...
        Builder from(ExperienceCompany other);
    }
    ...
    public static final class Builder implements IdStage, RouteStage, TitleStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ExperienceCompany other) {
            id(other.getId());
        ...
        @java.lang.Override
        public ExperienceCompany build() {
            return new ExperienceCompany(id, route, title, additionalProperties);
        }
