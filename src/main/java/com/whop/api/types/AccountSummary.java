...
public final class AccountSummary {
    ...
    private AccountSummary(String id, String title, Map<String, Object> additionalProperties) {
        this.id = id;
        this.title = title;
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof AccountSummary && equalTo((AccountSummary) other);
    }
    ...
    private boolean equalTo(AccountSummary other) {
    ...
    public interface IdStage {
        ...
        Builder from(AccountSummary other);
    }
    ...
    public static final class Builder implements IdStage, TitleStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(AccountSummary other) {
            id(other.getId());
        ...
        public AccountSummary build() {
            return new AccountSummary(id, title, additionalProperties);
        }
