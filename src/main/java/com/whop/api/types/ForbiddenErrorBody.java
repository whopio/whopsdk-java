...
@JsonDeserialize(builder = ForbiddenErrorBody.Builder.class)
public final class ForbiddenErrorBody {
    private final ForbiddenErrorBodyError error;

    private final Map<String, Object> additionalProperties;

    private ForbiddenErrorBody(ForbiddenErrorBodyError error, Map<String, Object> additionalProperties) {
        this.error = error;
        this.additionalProperties = additionalProperties;
    }

    @JsonProperty("error")
    public ForbiddenErrorBodyError getError() {
        return error;
    }
    ...
    public interface ErrorStage {
        _FinalStage error(@NotNull ForbiddenErrorBodyError error);

        Builder from(ForbiddenErrorBody other);
    }

    public interface _FinalStage {
        ForbiddenErrorBody build();
    ...
    public static final class Builder implements ErrorStage, _FinalStage {
        ...
        @java.lang.Override
        @JsonSetter("error")
        public _FinalStage error(@NotNull ForbiddenErrorBodyError error) {
