...
@JsonDeserialize(builder = NotificationSender.Builder.class)
public final class NotificationSender {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof NotificationSender && equalTo((NotificationSender) other);
    }
    ...
    private boolean equalTo(NotificationSender other) {
    ...
    public interface IdStage {
        ...
        Builder from(NotificationSender other);
    }
    ...
    public static final class Builder implements IdStage, UsernameStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(NotificationSender other) {
            id(other.getId());
            name(other.getName());
        ...
        public NotificationSender build() {
            return new NotificationSender(id, name, username, additionalProperties);
        }
