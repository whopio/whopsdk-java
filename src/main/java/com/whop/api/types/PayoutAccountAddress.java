...
@JsonDeserialize(builder = PayoutAccountAddress.Builder.class)
public final class PayoutAccountAddress {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof PayoutAccountAddress && equalTo((PayoutAccountAddress) other);
    }
    ...
    private boolean equalTo(PayoutAccountAddress other) {
    ...
    public static final class Builder {
        ...
        public Builder from(PayoutAccountAddress other) {
            city(other.getCity());
        ...
        public PayoutAccountAddress build() {
            return new PayoutAccountAddress(city, country, line1, line2, postalCode, state, additionalProperties);
        }
