...
public final class UnauthorizedErrorBody {
    private final UnauthorizedErrorBodyError error;

    private final Map<String, Object> additionalProperties;

    private UnauthorizedErrorBody(UnauthorizedErrorBodyError error, Map<String, Object> additionalProperties) {
        this.error = error;
        this.additionalProperties = additionalProperties;
    }

    @JsonProperty("error")
    public UnauthorizedErrorBodyError getError() {
        return error;
    }
    ...
    public interface ErrorStage {
        _FinalStage error(@NotNull UnauthorizedErrorBodyError error);
    ...
    public static final class Builder implements ErrorStage, _FinalStage {
        ...
        @java.lang.Override
        @JsonSetter("error")
        public _FinalStage error(@NotNull UnauthorizedErrorBodyError error) {
        ...
        public UnauthorizedErrorBody build() {
            return new UnauthorizedErrorBody(error, additionalProperties);
        }
