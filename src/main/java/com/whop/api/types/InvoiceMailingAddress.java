...
@JsonDeserialize(builder = InvoiceMailingAddress.Builder.class)
public final class InvoiceMailingAddress {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof InvoiceMailingAddress && equalTo((InvoiceMailingAddress) other);
    }
    ...
    private boolean equalTo(InvoiceMailingAddress other) {
    ...
    public int hashCode() {
        return Objects.hash(
                this.city, this.country, this.line1, this.line2, this.name, this.phone, this.postalCode, this.state);
    }
    ...
    public static final class Builder {
        ...
        public Builder from(InvoiceMailingAddress other) {
            city(other.getCity());
        ...
        public InvoiceMailingAddress build() {
            return new InvoiceMailingAddress(
                    city, country, line1, line2, name, phone, postalCode, state, additionalProperties);
        }
