...
@JsonDeserialize(builder = AppCreator.Builder.class)
public final class AppCreator {
    ...
    private AppCreator(String id, Optional<String> name, String username, Map<String, Object> additionalProperties) {
        this.id = id;
        this.name = name;
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof AppCreator && equalTo((AppCreator) other);
    }
    ...
    private boolean equalTo(AppCreator other) {
    ...
    public static final class Builder implements IdStage, UsernameStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(AppCreator other) {
            id(other.getId());
            name(other.getName());
        ...
        @java.lang.Override
        public AppCreator build() {
            return new AppCreator(id, name, username, additionalProperties);
        }
