...
@JsonDeserialize(builder = ReviewCompany.Builder.class)
public final class ReviewCompany {
    ...
    private ReviewCompany(String id, String route, String title, Map<String, Object> additionalProperties) {
        this.id = id;
        this.route = route;
        this.title = title;
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ReviewCompany && equalTo((ReviewCompany) other);
    }
    ...
    private boolean equalTo(ReviewCompany other) {
    ...
    public interface IdStage {
        ...
        Builder from(ReviewCompany other);
    }
    ...
    public static final class Builder implements IdStage, RouteStage, TitleStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ReviewCompany other) {
            id(other.getId());
        ...
        @java.lang.Override
        public ReviewCompany build() {
            return new ReviewCompany(id, route, title, additionalProperties);
        }
