...
public class Example {
    public static void main(String[] args) {
        WhopApiClient client = WhopApiClient
            .builder()
            .token("<token>")
            .build();
...
```java
import com.whop.api.WhopApiClient;
import com.whop.api.core.Environment;
...
```java
WhopApiHttpResponse response = client.accessTokens().withRawResponse().create(...);
